...
public class EventsShowFragment extends SherlockFragment implements LoaderCallbacks<EventsFullData>{
	public final static int LOADER_EVENT = 0;
	public final static String URL_ARGUMENT = "url";
    private String url;
    private EventsFullData eventsFullData;
	...
	@Override
	public Loader<EventsFullData> onCreateLoader(int id, Bundle args){
		showProgressDialog();
	...
	@Override
	public void onLoadFinished(Loader<EventsFullData> loader, EventsFullData data){
	...
	@Override
	public void onLoaderReset(Loader<EventsFullData> loader){
